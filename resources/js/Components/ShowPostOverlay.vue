...
// used to explicitly declare the event that a component can emit to communite with parent component or other parts of the application
defineEmits(["closeOverlay", "addComment", "updateLike", "deleteSelected"]);

const textareaInput = (e) => {
    textarea.value.style.height = "auto";
    textarea.value.style.height = `${e.target.scrollHeigh}px`;
};
</script>
        ...
        >
            <div class="w-full md:flex h-full overflow-auto rounded-xl">
                <div class="flex items-center bg-black w-full">
                    <img
                        class="rounded-xl max-w-[400px] p-4 mx-auto"
