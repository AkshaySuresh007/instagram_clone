...
const getUploadedImage = (e) => {
    ...
    router.post(`/user`, form, {
        preserveState: false, // to not to retain the application current data and values, expecting the page to reload or navigate to a new page after the completing the request
    });
};
</script>
        ...
        <div class="max-w-[880px] lg:ml-0 md:ml-[80px] md:pl-20 px-4 w-[100vw]">
            <div class="flex items-center md:justify-between">
                ...
                <div class="ml-6 w-full">
                    ...
                    <button
                        class="md:hidden mr-6 p1 px-4 max-w-[260px] w-full rounded-lg text-[17px] font-extrabold bg-gray-100 hover:bg-gray-200"
                    >
                        Edit Profile
                    </button>
